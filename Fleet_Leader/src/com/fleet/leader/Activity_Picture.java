...
public class Activity_Picture extends ActionBarActivity {
	...
	ProgressDialog dialog;// 显示是否上传的对话框
	...
	PictureCallback myJpegCallback = new PictureCallback() {
		...
		public void onPictureTaken(byte[] data, Camera camera) {
			...
			new AlertDialog.Builder(Activity_Picture.this)
					.setView(saveDialog)
	...
	Handler mHandler = new Handler(){
		public void handleMessage(android.os.Message msg) {
			switch (msg.what) {
			case 1:
				Toast.makeText(Activity_Picture.this, "上传成功！",
						Toast.LENGTH_LONG).show();
				break;

			case 2:
				Toast.makeText(Activity_Picture.this, "上传失败！",
						Toast.LENGTH_LONG).show();
				break;
			default:
				break;
	...
	private void post(){
		dialog = new ProgressDialog(Activity_Picture.this);
		...
		new Thread(){
			public void run() {
				...
				try {
					HttpPost httppost = new HttpPost(Utils.uploadPicIp);
					...
					entity.addPart("picture", new ByteArrayBody(data, "temp.jpg"));
